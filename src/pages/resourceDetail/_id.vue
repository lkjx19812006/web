        ...
        <div class="resource_detail_content">
            <div class="intention_detail">
                ...
                <div class="intention">
                    ...
                    <div class="intention_row">
                        <div class='left'>采购价格：<span class='speacil_left'>{{intention.price}}</span><span class='speacil_left'>元/{{intention.unit}}</span></div>
                        <div class='right'>规格：
                    ...
                    <div class="intention_row">
                        <div>
                            <span>采购数量:</span>
                            <el-input v-model="number" type="number" :min="intention.moq" :max="intention.number" :maxlength="10" class="number_width">
