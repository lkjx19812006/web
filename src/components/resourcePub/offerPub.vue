        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="产地" prop="location">
                ...
                <el-select v-model="ruleForm.location" placeholder="请选择产地">
                    <el-option v-for="item in locationOptions" :label="item.name" :key="item.locationId" :value="item.locationId">
                    </el-option>
                </el-select>
            </el-form-item>
                ...
                <template>
                    <el-input type="number" v-model.number="ruleForm.number" placeholder="请输入数量">
                        <el-select style="width: 120px;" v-model.number="ruleForm.unit" slot="append" placeholder="请选择单位">
                            <el-option v-for="item in unit" :label="item.name" :key="item.id" :value="item.id"></el-option>
                        </el-select>
                    </el-input>
                </template>
            </el-form-item>
            ...
            <el-form-item label="货物图片" prop="image">
                ...
                <ul class="img_items" v-show="ruleForm.editImage.length > 0">
                    <li class="img_item" v-on:mouseenter="showModelIndex = index" v-on:mouseleave="showModelIndex = -1" :key="index" v-for="(item, index) in ruleForm.editImage">
                        <img :src="item" alt="">
...
import breed from '../publish/breed.vue'
