...
<template>
  <div class="foot_content">
    ...
    <div>
      ...
      <a href="../../static/icon/zs.jpg" target="_blank">互联网药品信息服务资格证编号（沪）-非经营性-2016-0068</a>
    </div>
    <div>
      <ul>
        <li>
          <a href="http://xinyong.360.cn/detail/yaocaimaimai.com" target="_blank"><img height=40    width=110
            src="../assets/images/credit_platform.png"/></a>
        </li>
        <li>
        ...
        <li>
          <a target="_blank" href="http://webscan.360.cn/index/checkwebsite/url/yaocaimaimai.com"><img height=40
            width=110
            src="../assets/images/safety_test.png"/></a>
        </li>
        <li>
          <a target="_blank" href="http://www.12377.cn/"><img height=40    width=110
            src="../assets/images/reporting_center.jpg"/></a>
        </li>
      </ul>
    </div>
  </div>
